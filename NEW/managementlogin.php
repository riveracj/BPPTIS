...
<form action="managementloginindex.php" method="post" style="max-width:300px;margin:5px; border: 1px solid gray; padding: 10px;box-shadow: 0 0 8px rgba(0,0,0,0.1); " >
  <div class="container">
